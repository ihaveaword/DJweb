...
function initBackgroundOpacity() {
    ...
    const maxScroll = 2000; // 滚动到此距离时达到最大透明度
    const minOpacity = 0.5; // 顶部遮罩层透明度（50%，背景图片可见50%）
    const maxOpacity = 0.75; // 底部遮罩层透明度（75%，背景图片可见25%）
    ...
    function updateOpacity() {
        ...
        const scrollProgress = Math.min(scrollY / maxScroll, 1); // 0到1之间
